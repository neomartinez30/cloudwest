        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fadeIn">
              AI Agents That Automate <span className="text-teal-400">Back-Office Work</span> for Small Businesses
            </h1>

            <p className="text-lg md:text-xl text-blue-100 mb-8 animate-fadeIn animation-delay-200">
              CloudWest builds intelligent AI agents that handle the repetitive, manual work slowing your team down — from claims processing and billing to document review and compliance. Purpose-built for your industry, powered by shared AI infrastructure.
            </p>
