...
import { Bot, Rocket, Headphones, Code, Database, Shield, Zap, Target, Users, ShieldCheck, Heart, Landmark, Home } from 'lucide-react';
...
const verticals = [
  {
    ...
    title: "Insurance",
    description: "Claims triage, policy automation, and underwriting workflows.",
    path: "/insurance"
  },
  {
    icon: <Heart className="h-8 w-8 text-blue-700" />,
    title: "Healthcare",
    description: "Front-office contact centers and back-office revenue cycle automation.",
    path: "/healthcare"
  },
  {
    icon: <Landmark className="h-8 w-8 text-blue-700" />,
    title: "Government",
    description: "Citizen services, permit processing, and compliance tracking.",
    path: "/government"
  },
  {
    icon: <Home className="h-8 w-8 text-blue-700" />,
    title: "Real Estate",
    description: "Mortgage processing, title search, and escrow management.",
    path: "/real-estate"
  }
];
    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-16 mb-16">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Industries We Serve</h3>
          <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">
            One AI platform, tailored for your industry. We go deep in each vertical with custom messaging, integrations, and workflows—powered by shared intelligent infrastructure.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {verticals.map((v, index) => (
              <button
                key={index}
                onClick={() => { navigate(v.path); window.scrollTo(0, 0); }}
                className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg hover:border-blue-200 transition-all duration-300 text-left group"
              >
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">{v.title}</h4>
